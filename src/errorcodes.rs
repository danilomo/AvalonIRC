...
pub const RPL_MAP: &str = "015";
pub const RPL_MAPEND: &str = "017";
pub const RPL_MAPSTART: &str = "018";
pub const RPL_HELLO: &str = "020";
pub const RPL_YOURID: &str = "042";
pub const RPL_SAVENICK: &str = "043";
...
pub const RPL_STATSIAUTH: &str = "239";
...
pub const RPL_STATSSLINE: &str = "245";
pub const RPL_STATSPING: &str = "246";
pub const RPL_STATSBLINE: &str = "247";
pub const RPL_STATSDEFINE: &str = "248";
pub const RPL_STATSDEBUG: &str = "249";
...
pub const RPL_TOPIC_WHO_TIME: &str = "333";
pub const RPL_INVITING: &str = "341";
pub const RPL_SUMMONING: &str = "342";
pub const RPL_REOPLIST: &str = "344";
pub const RPL_ENDOFREOPLIST: &str = "345";
...
pub const RPL_NOTOPERANYMORE: &str = "385";
...
pub const ERR_TOOMANYMATCHES: &str = "416";
...
pub const ERR_SERVICENAMEINUSE: &str = "434";
pub const ERR_SERVICECONFUSED: &str = "435";
...
pub const ERR_STATSKLINE: &str = "499";
pub const ERR_UMODEUNKNOWNFLAG: &str = "501";
pub const ERR_USERSDONTMATCH: &str = "502";
pub const RPL_ETRACEFULL: &str = "708";
pub const RPL_ETRACEEND: &str = "759";
